...
class IDotExporter:
    ...
    def create_leaf(self, dot, id, label):
        dot.node(id, label, shape='box', color='green', style='filled')
...
class LET(EXPRESSION):
    ...
    def to_dot(self, dot):
        ...
        for index, decl in enumerate(self.declarations):
            self.create_edge(dot, self.getNodeId(), decl.to_dot(dot))
        ...
        self.create_edge(dot, self.getNodeId(), self.body.to_dot(dot))
...
class DECL(EXPRESSION):
    ...
    def to_dot(self, dot):
        ...
        for index, param in enumerate(self.params):
            self.create_edge(dot, self.getNodeId(), param.to_dot(dot))
            # Füge ein ","-Blatt zwischen den Deklarationen ein
...
class CALL(EXPRESSION):
    ...
    def to_dot(self, dot):
        ...
        for index, arg in enumerate(self.arguments):
            self.create_edge(dot, self.getNodeId(), arg.to_dot(dot))
            # Füge ein ","-Blatt zwischen den Deklarationen ein
...
class BINOP(EXPRESSION):
    ...
    def to_dot(self, dot):
        ...
        self.create_edge(dot, self.getNodeId(), self.arg1.to_dot(dot))
        self.create_leaf(dot, "op_" + self.getNodeId(), self.operator)
        self.create_edge(dot, self.getNodeId(), "op_" + self.getNodeId())
        self.create_edge(dot, self.getNodeId(), self.arg2.to_dot(dot))
        return self.getNodeId()
...
class ASSIGN(EXPRESSION):
    ...
    def to_dot(self, dot):
        ...
        self.create_edge(dot, self.getNodeId(), self.variable.to_dot(dot))
        self.create_leaf(dot, "assign_" + self.getNodeId(), "=")
        self.create_edge(dot, self.getNodeId(), "assign_" + self.getNodeId())
        self.create_edge(dot, self.getNodeId(), self.expression.to_dot(dot))
        return self.getNodeId()
...
class SEQ(EXPRESSION):
    ...
    def to_dot(self, dot):
        ...
        self.create_edge(dot, self.getNodeId(), self.exp1.to_dot(dot))
        self.create_leaf(dot, "seq_" + self.getNodeId(), ";")
        self.create_edge(dot, self.getNodeId(), "seq_" + self.getNodeId())
        self.create_edge(dot, self.getNodeId(), self.exp2.to_dot(dot))
        return self.getNodeId()
...
class IF(EXPRESSION):
    ...
    def to_dot(self, dot):
        ...
        self.create_edge(dot, self.getNodeId(), self.condition.to_dot(dot))
